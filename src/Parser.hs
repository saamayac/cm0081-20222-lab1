...
action_0,
 ...
 action_14,
 action_15,
 action_16 :: () => Prelude.Int -> ({-HappyReduction (HappyIdentity) = -}
	   Prelude.Int 
	-> (Token)
...
happyReduce_1,
 ...
 happyReduce_6,
 happyReduce_7,
 happyReduce_8 :: () => ({-HappyReduction (HappyIdentity) = -}
	   Prelude.Int 
	-> (Token)
	-> HappyState (Token) (HappyStk HappyAbsSyn -> [(Token)] -> (HappyIdentity) HappyAbsSyn)
	-> [HappyState (Token) (HappyStk HappyAbsSyn -> [(Token)] -> (HappyIdentity) HappyAbsSyn)] 
...
happyExpList = Happy_Data_Array.listArray (0,32) ([1408,352,256,18,0,2048,5632,0,512,32,32768,5,22528,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_happyParser","TermList","Term","AppTerm","aTerm","var","lam","\".\"","\"(\"","\")\"","\";\"","%eof"]
